...
@section('page-content')
    ...
    <div class="page-content">
        <!-- inner page banner -->
        <div class="dlab-bnr-inr overlay-black-middle" style="background-image:url(images/banner/1.jpg);">
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white">Equipment Rental-Internal</h1>
        ...
        <div class="breadcrumb-row">
            <div class="container">
                ...
                <ul class="list-inline">
                    ...
                    <li><a href="{{ route('equipment_rental_internal') }}" style="color:#151345">Equipment Rental-Internal</a></li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumb row END -->
