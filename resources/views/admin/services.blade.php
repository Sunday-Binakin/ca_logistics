                            ...
                            <div class="row p-t-5">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" required name="title" class="form-control" placeholder="Enter  Title ">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text"  name="summary" rows="5" class="form-control" placeholder=" summary "></textarea>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    <label class="control-label">Service Body</label>
                                    <textarea name="body" >
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu animated lightSpeedIn" x-placement="bottom-start" style="position: absolute; transform: translate3d(69px, 35px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                <a class="dropdown-item" href="{{url('admin/service/'.$s->id.'/edit')}}">Edit</a>
                                                <a class="dropdown-item" href="{{url('admin/service/'.$s->id.'/delete')}}">Delete</a>
